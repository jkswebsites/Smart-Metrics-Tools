...
export const metadata: Metadata = {
  ...
  keywords:
    'Bora Poupar App, poupar, investimento, econômia, controle de gastos',
  description:
    'Bora Poupar App é uma aplicação web para gerenciar seus gastos de forma prática e eficiênte.',
};
