    ...
    <div className="mx-auto mb-3 h-[250px] w-[98%] overflow-auto rounded-lg border border-neutral-800 bg-neutral-900 p-1">
      {participants.length > 0 && (
        <ul className="space-y-1">
          <li className="h-12 w-full rounded-md border border-neutral-700 bg-neutral-900 px-2 pb-1 pt-1">
            <div className="flex justify-between">
              <p className="font-montserrat font-bold tracking-wide">Carlos</p>
