...
const FormTax = ({ setMetris }: FormTaxProps) => {
  ...
  return (
    <div className="mx-auto w-[90%] rounded-lg bg-neutral-900 sm:w-[350px]">
      ...
      >
        <label>
          <p className="mb-1 text-sm italic text-neutral-100">Taxas do IFood</p>
          <input
            type="number"
            {...register('totalTax', { required: true })}
            step={'0.01'}
            placeholder="Informe o total de taxas"
            className="rounded-lg border border-neutral-100 bg-neutral-800 px-3 py-2 text-lg font-semibold italic tracking-wider outline-none placeholder:text-xs focus:border-emerald-500 focus:bg-neutral-950"
          />
        ...
        <label>
          <p className="mb-1 text-sm italic text-neutral-100">
        ...
        <button className="w-4/5 rounded-md bg-emerald-500 py-1 text-neutral-800">
          Confirmar
        </button>
      </form>
    </div>
